  ...
  <div class="container">
    ...
    <header class="jumbotron text-center">
      <img src="https://s3.ap-northeast-2.amazonaws.com/opentutorials-user-file/course/94.png" alt="생활코딩" class="img-circle" id="logo">
        <h1><a href="http://localhost/index1.php">JavaScript</a></h1>
    </header>
    <div class="row">
        ...
        <nav class="col-md-3">
          ...
          while( $row = mysqli_fetch_assoc($result)){
            echo '<li><a href="http://localhost/index1.php?id='.$row['id'].'">'.htmlspecialchars($row['title']).'</a></li>'."\n";
          }
          ?>
          </ ol>
        </nav>
        <div class="col-md-9">
          ...
          <div id="control">
            ...
            <a href="http://localhost/write1.php" class="btn btn-success  btn-lg">쓰기</a>
          </div>
        </div>
    </div>
  </div>
